...
export type ProductSubscriptionSubscriptionVariables = Exact<{
  event?: InputMaybe<EventEnum>;
}>;


export type ProductSubscriptionSubscription = { __typename?: 'Subscription', products_mutated?: { __typename?: 'products_mutated', key: string, event?: EventEnum | null, data?: { __typename?: 'products', id: string, name: string, price: number, status?: string | null, date_updated?: any | null, user_created?: { __typename?: 'directus_users', id: string } | null } | null } | null };

export type OrderSubscriptionSubscriptionVariables = Exact<{
  event?: InputMaybe<EventEnum>;
}>;


export type OrderSubscriptionSubscription = { __typename?: 'Subscription', orders_mutated?: { __typename?: 'orders_mutated', key: string, event?: EventEnum | null, data?: { __typename?: 'orders', id: string, status?: string | null, total_price?: number | null, date_updated?: any | null, customers_id?: { __typename?: 'customers', id: string, nick_name?: string | null } | null, user_created?: { __typename?: 'directus_users', id: string } | null } | null } | null };

export type CategorySubscriptionSubscriptionVariables = Exact<{
  event?: InputMaybe<EventEnum>;
}>;


export type CategorySubscriptionSubscription = { __typename?: 'Subscription', categories_mutated?: { __typename?: 'categories_mutated', key: string, event?: EventEnum | null, data?: { __typename?: 'categories', id: string, name: string, description?: string | null, date_updated?: any | null, user_created?: { __typename?: 'directus_users', id: string } | null } | null } | null };

export type CustomerSubscriptionSubscriptionVariables = Exact<{
  event?: InputMaybe<EventEnum>;
}>;


export type CustomerSubscriptionSubscription = { __typename?: 'Subscription', customers_mutated?: { __typename?: 'customers_mutated', key: string, event?: EventEnum | null, data?: { __typename?: 'customers', id: string, nick_name?: string | null, status?: string | null, date_updated?: any | null, user_created?: { __typename?: 'directus_users', id: string } | null } | null } | null };

export type BoutiqueSubscriptionSubscriptionVariables = Exact<{
  event?: InputMaybe<EventEnum>;
}>;


export type BoutiqueSubscriptionSubscription = { __typename?: 'Subscription', boutiques_mutated?: { __typename?: 'boutiques_mutated', key: string, event?: EventEnum | null, data?: { __typename?: 'boutiques', id: string, name?: string | null, status?: string | null, date_updated?: any | null, user_created?: { __typename?: 'directus_users', id: string } | null } | null } | null };
...
export function useProductSubscriptionSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<ProductSubscriptionSubscription, ProductSubscriptionSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useSubscription<ProductSubscriptionSubscription, ProductSubscriptionSubscriptionVariables>(ProductSubscriptionDocument, options);
      }
...
export function useOrderSubscriptionSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<OrderSubscriptionSubscription, OrderSubscriptionSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useSubscription<OrderSubscriptionSubscription, OrderSubscriptionSubscriptionVariables>(OrderSubscriptionDocument, options);
      }
...
export const CategorySubscriptionDocument = gql`
...
/**
 * __useCategorySubscriptionSubscription__
 *
 * To run a query within a React component, call `useCategorySubscriptionSubscription` and pass it any options that fit your needs.
 * When your component renders, `useCategorySubscriptionSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCategorySubscriptionSubscription({
 *   variables: {
 *      event: // value for 'event'
 *   },
 * });
 */
export function useCategorySubscriptionSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<CategorySubscriptionSubscription, CategorySubscriptionSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useSubscription<CategorySubscriptionSubscription, CategorySubscriptionSubscriptionVariables>(CategorySubscriptionDocument, options);
      }
export type CategorySubscriptionSubscriptionHookResult = ReturnType<typeof useCategorySubscriptionSubscription>;
export type CategorySubscriptionSubscriptionResult = ApolloReactCommon.SubscriptionResult<CategorySubscriptionSubscription>;
export const CustomerSubscriptionDocument = gql`
...
/**
 * __useCustomerSubscriptionSubscription__
 *
 * To run a query within a React component, call `useCustomerSubscriptionSubscription` and pass it any options that fit your needs.
 * When your component renders, `useCustomerSubscriptionSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCustomerSubscriptionSubscription({
 *   variables: {
 *      event: // value for 'event'
 *   },
 * });
 */
export function useCustomerSubscriptionSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<CustomerSubscriptionSubscription, CustomerSubscriptionSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useSubscription<CustomerSubscriptionSubscription, CustomerSubscriptionSubscriptionVariables>(CustomerSubscriptionDocument, options);
      }
export type CustomerSubscriptionSubscriptionHookResult = ReturnType<typeof useCustomerSubscriptionSubscription>;
export type CustomerSubscriptionSubscriptionResult = ApolloReactCommon.SubscriptionResult<CustomerSubscriptionSubscription>;
export const BoutiqueSubscriptionDocument = gql`
...
/**
 * __useBoutiqueSubscriptionSubscription__
 *
 * To run a query within a React component, call `useBoutiqueSubscriptionSubscription` and pass it any options that fit your needs.
 * When your component renders, `useBoutiqueSubscriptionSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBoutiqueSubscriptionSubscription({
 *   variables: {
 *      event: // value for 'event'
 *   },
 * });
 */
export function useBoutiqueSubscriptionSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<BoutiqueSubscriptionSubscription, BoutiqueSubscriptionSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useSubscription<BoutiqueSubscriptionSubscription, BoutiqueSubscriptionSubscriptionVariables>(BoutiqueSubscriptionDocument, options);
      }
export type BoutiqueSubscriptionSubscriptionHookResult = ReturnType<typeof useBoutiqueSubscriptionSubscription>;
export type BoutiqueSubscriptionSubscriptionResult = ApolloReactCommon.SubscriptionResult<BoutiqueSubscriptionSubscription>;